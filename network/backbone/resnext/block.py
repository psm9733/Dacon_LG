...
def ResidualBlock(in_tensor, filter_list, kernel_size, strides, groups, activation, weight_decay):
    '''
    ...
    conv2d_2_out_tensor = Conv2dBnAct(conv2d_1_out_tensor, filter_list[1], kernel_size, strides, groups=groups, activation=activation,
                                      weight_decay=weight_decay)
